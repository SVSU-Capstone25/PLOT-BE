...
builder.Services.AddAuthorizationBuilder()
    .AddPolicy("Employee", policy => policy.RequireClaim("Role", "1", "2", "3"))
    .AddPolicy("Manager", policy => policy.RequireClaim("Role", "2", "3"))
    .AddPolicy("Owner", policy => policy.RequireClaim("Role", "3"));
