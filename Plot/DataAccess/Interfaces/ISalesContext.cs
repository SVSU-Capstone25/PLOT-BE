...
{
    Task<int> UploadSales(List<CreateFixtureAllocations> allocations, CreateExcelFileModel excelFile);
    ...
    //Task<int> SaveFileToDatabase(CreateExcelFileModel excelFile);
}